...
class SearchABCRequestHandler(http.server.BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        # print(maybe_content)
        maybe_content = {'title':'Shefali Sharma is the worlds fastest woman','content':"Shefali Sharma is the worlds fastest woman", 'url':'https://en.wikipedia.org/wiki/Rishi_Sunak'}
